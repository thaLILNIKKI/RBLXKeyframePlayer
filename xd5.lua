-- KeyframePlayer Loadstring Bundle (FIXED)
-- Original by RAMPAGE Interactive, modified for recursive part search
...
-- ============================================
-- 🔥 ЕДИНСТВЕННОЕ ИЗМЕНЕНИЕ: рекурсивный поиск
-- ============================================
